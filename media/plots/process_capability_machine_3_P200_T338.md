...
# Save plot to PNG
png(filename = "/content/project/media/plots/process_capability_machine_3_P200_T338.png", width = 800, height = 600)
plot(pc_m3, title=paste0("Process Capability for Machine ", machine_id, " (P=", pressure_val, "kPa, T=", temperature_val, "K)"))
dev.off()
